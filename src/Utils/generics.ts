...
export const generateMessageID = () => 'QUEENELISA' + randomBytes(6).toString('hex').toUpperCase()
...
export const fetchLatestBaileysVersion = async(options: AxiosRequestConfig<any> = { }) => {
	const URL = 'https://github.com/mr-nima-0/Baileys/main/src/Defaults/baileys-version.json'
	try {
