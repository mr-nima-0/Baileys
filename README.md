...
```
yarn add github:baileyss
```

Then import your code using:
``` ts 
import makeWASocket from 'btc/baileys'
```
...
``` ts
import makeWASocket, { DisconnectReason } from 'btc/baileys'
...
``` ts
import makeWASocket, { BufferJSON, useMultiFileAuthState } from 'btc/baileys'
...
``` ts
import makeWASocket, { makeInMemoryStore } from 'btc/baileys'
...
``` ts
import { MessageType, MessageOptions, Mimetype } from 'btc/baileys'
...
- **MiscGenerationOptions**: some extra info about the message. It can have the following __optional__ values:
    ...
    const info: MessageOptions = {
        ...
        mimetype: Mimetype.pdf, /* (for media messages) specify the type of media (optional for all media types except documents),
                                    import {Mimetype} from '@btc/baileys'
                                */
...
import { downloadMediaMessage } from '@btc/baileys'
